...
class CFFMHead_clips_resize1_8_vpattn(BaseDecodeHead_clips_flow):
    """
    SegFormer: Simple and Efficient Design for Semantic Segmentation with Transformers
    """
    def __init__(self, feature_strides, **kwargs):
        super(CFFMHead_clips_resize1_8_vpattn, self).__init__(input_transform='multiple_select', **kwargs)
