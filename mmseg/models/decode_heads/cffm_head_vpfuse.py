...
from .cffm_module.cffm_transformer_vanishing_point_fuse import BasicLayer3d3
...
class CFFMHead_clips_resize1_8_vpfuse(BaseDecodeHead_clips_flow):
    """
    SegFormer: Simple and Efficient Design for Semantic Segmentation with Transformers
    """
    def __init__(self, feature_strides, **kwargs):
        super(CFFMHead_clips_resize1_8_vpfuse, self).__init__(input_transform='multiple_select', **kwargs)
