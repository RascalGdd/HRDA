...
class HRDAHead(BaseDecodeHead):
        ...
        if single_scale_head == 'DAFormerHead':
            ...
            if attn_cfg['decoder_params']['fusion_cfg']['type'] == 'aspp':
                attn_cfg['decoder_params']['fusion_cfg'] = dict(
                    ...
                    ['norm_cfg'])
            head_cfg['decoder_params']['pos_emb_dim'] = 0
            head_cfg['decoder_params']['depthmap_emb_dim'] = 0
    ...
    def forward(self, inputs):
        ...
        if self.lr_only or self.hr_only:
            ...
            for feat in lr_sc_att_inp: # add detach
                feat.detach()
    ...
    def forward_train(self,
        ...
        if self.enable_hr_crop and not self.lr_only and not self.hr_only:
