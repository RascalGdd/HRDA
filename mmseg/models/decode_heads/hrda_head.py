    ...
    def __init__(self,
        ...
        if single_scale_head == 'DLV2Head':
            ...
            if 'b0' in single_scale_head:
                attn_cfg = dict(attn_cfg, **CFFM_head_config_b0)
            elif 'b1' in single_scale_head:
                attn_cfg = dict(attn_cfg, **CFFM_head_config_b1)
            elif 'b3' in single_scale_head:
                attn_cfg = dict(attn_cfg, **CFFM_head_config_b3)
            else:
