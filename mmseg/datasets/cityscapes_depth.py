...
class CityscapesDatasetDepth(CustomDatasetDepth):
    """Cityscapes dataset.
    ...
    def __init__(self,
        ...
        super(CityscapesDatasetDepth, self).__init__(
            img_suffix=img_suffix, seg_map_suffix=seg_map_suffix, depth_map_suffix=depth_map_suffix, **kwargs)

        self.pseudo_margins = crop_pseudo_margins
        self.valid_mask_size = [1024, 2048]

    def pre_pipeline(self, results):
        super(CityscapesDatasetDepth, self).pre_pipeline(results)
