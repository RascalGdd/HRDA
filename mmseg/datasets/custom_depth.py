...
class CustomDatasetDepth(Dataset):
    ...
    def get_dep_info(self, idx):
        ...
        Returns:
            dict: Depth map info of specified index.
        """
    ...
    def pre_pipeline(self, results):
        ...
        results['dep_prefix'] = self.dep_dir
    ...
    def prepare_train_img(self, idx):
        ...
        dep_info = self.get_dep_info(idx)
        results = dict(img_info=img_info, ann_info=ann_info, dep_info=dep_info)
    ...
    def prepare_test_img(self, idx):
        ...
        img_info = self.img_infos[idx]
        dep_info = self.get_dep_info(idx)
        results = dict(img_info=img_info, dep_info=dep_info)
        self.pre_pipeline(results)
        return self.pipeline(results)
